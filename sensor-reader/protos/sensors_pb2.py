...
_READING = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='sensors.Reading.value', index=0,
...
Reading = _reflection.GeneratedProtocolMessageType('Reading', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:sensors.Reading)
  })
